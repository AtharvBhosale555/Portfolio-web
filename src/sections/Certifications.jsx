    ...
    <section id="certifications" className="py-16">
      <div className="mx-auto max-w-6xl">
        <div className="mb-10">
          ...
          <h2 className="mt-3 text-3xl font-semibold text-white sm:text-4xl">Verified Skills</h2>
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {certifications.map((cert, index) => (
            ...
            >
              <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Certification</p>
